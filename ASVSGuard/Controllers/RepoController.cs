...
public class RepoController : Controller
{
    ...
    public async Task<IActionResult> Result(int id)
    {
        ...
        var vm = new ScanResultViewModel(
            ...
            scan.ScannedAt,
            scan.Findings.Count,
            scan.Findings.Count(f => f.FindingStatus == ASVSGuard.Core.Entities.FindingStatus.Present),
            scan.Findings.Count(f => f.FindingStatus == ASVSGuard.Core.Entities.FindingStatus.Partial),
            scan.Findings.Count(f => f.FindingStatus == ASVSGuard.Core.Entities.FindingStatus.Missing),
            byCategory,
            scan.Status,
            scan.ErrorMessage);
